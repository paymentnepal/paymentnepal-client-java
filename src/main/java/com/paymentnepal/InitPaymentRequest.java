...
public class InitPaymentRequest {
    ...
    public Map<String, String> getParams() throws PaymentNepalFatalError {
        ...
        if (recurrentParams != null) {
            if (recurrentParams.type == RecurrentType.FIRST) {
                ...
                if (!background) {
                    throw new PaymentNepalFatalError("When recurrent_type is \"next\" then background should be \"1\"");
                } else {
