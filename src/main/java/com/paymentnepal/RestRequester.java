...
public class RestRequester {
    ...
    private String buildUrlParams(Map<String, String> params) throws UnsupportedEncodingException, PaymentNepalFatalError {
        ...
        for (Entry<String, String> entry : params.entrySet()) {
            ...
            if (entry.getValue() == null) {
                throw new PaymentNepalFatalError("The parameter " + entry.getKey() + " is required");
            }
    ...
    public JSONObject getRequest(String url, Map<String, String> params) throws IOException, PaymentNepalFatalError {
        ...
        if (conn instanceof HttpsURLConnection) {
            ...
            try {
                ...
                throw new PaymentNepalFatalError("Can't create socket factory (Key error)");
            } catch (NoSuchAlgorithmException e) {
                throw new PaymentNepalFatalError("Can't create socket factory (No such algorithm)");
            }
        } else {
    ...
    public JSONObject postRequest(String url, Map<String, String> params) throws IOException, PaymentNepalFatalError {
        int retry;
        ...
        throw new PaymentNepalFatalError("Status is pending " + String.valueOf(retry) + "times");
    }
}
