...
public class InitPaymentResponse {
    ...
    public InitPaymentResponse(JSONObject jsonObject) throws PaymentNepalTemporaryError {
        try {
            this.transactionId = jsonObject.getInt("tid");
        } catch (JSONException e) {
            throw new PaymentNepalTemporaryError("The response does't contain a transaction tid");
        }
